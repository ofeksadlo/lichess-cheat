...
7) In the config.ini you can control which color you start as. And use the auto play function.
   autoPlay: 1 = On, 0 = Off
   playerColor: 'w' = White, 'b' = Black
   showBoard: 1 = Show window, 0 Don't show window
   Default values:
   autoPlay=0
   playerColor='w'
   showBoard=1
